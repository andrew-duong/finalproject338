...
import com.example.datastructures.Linear.DLL;
...
public class DLLTest {
    ...
    public void sortTest() {
        ...
        // Here, the DLL is unordered, Sort() should order from least to
        // greatest
        ...
        assertTrue("isSorted did not return true when DLL was sorted using Sort().", actualResult);
        ...
        assertTrue("isSorted did not return true for pre-sorted DLL.", actualSort);
    }
    ...
    public void searchTest() {
        ...
        assertEquals("Search for existing node in DLL returned incorrect node.", node3, realVal);
        assertNull("Search for non-exising node in DLL returned non-null.", nullVal);
    }
    ...
    public void delTest() {
        ...
        assertEquals("Size of DLL is not correct after the deletions.", expectedSize, actualSize);
    }
